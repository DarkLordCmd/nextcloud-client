...
const messages = {
  en: {
    ...
    'viewmode.title': 'View mode (Ctrl+wheel)',
    ...
    'viewmode.xlarge': 'Extra large icons',
    'search.placeholder': 'Search storage…',
    'search.hint': 'Search by name across the whole storage (Ctrl+F)',
    'search.resultsTitle': 'Results for «{q}»',
    'search.count': '{count} found',
    'search.truncated': 'Showing first {count}',
    ...
    'trash.deleteConfirm': 'Permanently delete "{name}"? This cannot be undone.',
    'trash.emptyConfirm': 'Permanently delete all items in the trash?',
    'quota.loading': '…',
    'quota.used': 'Used: {used}',
    'quota.of': '{used} of {total} ({pct}%)',
  ...
  ru: {
    ...
    'viewmode.title': 'Режим просмотра (Ctrl+колесо)',
    'viewmode.content': 'Содержимое',
    'viewmode.tiles': 'Плитка',
    'viewmode.table': 'Таблица',
    'viewmode.list': 'Список',
    'viewmode.small': 'Мелкие значки',
    'viewmode.medium': 'Обычные значки',
    'viewmode.large': 'Крупные значки',
    'viewmode.xlarge': 'Огромные значки',
    'search.placeholder': 'Поиск по хранилищу…',
    'search.hint': 'Поиск по имени во всём хранилище (Ctrl+F)',
    'search.resultsTitle': 'Результаты: «{q}»',
    ...
    'trash.count': 'Элементов: {count}',
    'trash.restore': 'Восстановить',
    'trash.delete': 'Удалить навсегда',
    'trash.emptyAll': 'Очистить корзину',
    'trash.deleted': 'Удалён',
    'trash.deleteConfirm': 'Удалить «{name}» навсегда? Это действие необратимо.',
    'trash.emptyConfirm': 'Удалить все элементы корзины навсегда?',
    'quota.loading': '…',
    'quota.used': 'Занято: {used}',
    'quota.of': '{used} из {total} ({pct}%)',
